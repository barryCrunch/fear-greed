...
call = 'https://min-api.cryptocompare.com/data/v2/histohour?fsym=ETH&tsym=USD&limit=2000'
...
while earliest > START_TIME:
    ...
    print(earliest)
    call = f'https://min-api.cryptocompare.com/data/v2/histohour?fsym=ETH&tsym=USD&toTs={str(earliest)}&limit=2000'
    response = requests.get(call)
